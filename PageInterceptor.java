...
public class PageInterceptor implements Interceptor {
    ...
    private void setPageParameter(String sql, Connection connection, MappedStatement mappedStatement,
        ...
        if (page == null) {
            throw new BusinessException("分页参数异常！");
        }
        // 记录总记录数
        String countSql = MySqlPageHepler.getCountString(sql);
    ...
    public StringBuilder buildPageSqlForMysql(String sql, Page page) {
        ...
        String beginrow = String.valueOf(page.getStartNo());
        pageSql.append(sql);
        pageSql.append(" limit " + beginrow + "," + page.getRowNum());
        return pageSql;
    }
    ...
    public StringBuilder buildPageSqlForOracle(String sql, Page page) {
        ...
        String beginrow = String.valueOf((page.getPage() - 1)
                * page.getRowNum());
        String endrow = String.valueOf(page.getPage()
                * page.getRowNum());
